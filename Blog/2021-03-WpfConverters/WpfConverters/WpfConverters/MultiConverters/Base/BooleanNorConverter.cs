...
namespace WpfConverters.MultiConverters.Base {
    public class BooleanNorConverter<T> : BaseMultiValueConverter {
        ...
        public BooleanNorConverter(T @true, T @false) {
            True = @true;
            False = @false;
        }
        ...
        public override Object Convert(Object[] values, Type targetType, Object parameter, CultureInfo culture) {
            ...
            return !values.Cast<Boolean>().Any(value => value) ? True : False;
        }
